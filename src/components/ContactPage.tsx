                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <option value="TCG REFRESH">TCG REFRESH (From £60)</option>
                      <option value="TCG RESET">TCG RESET (From £130)</option>
                      <option value="TCG PROTECT">TCG PROTECT (From £200)</option>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-black rounded-lg p-6 border border-gray-800">
              ...
              <p className="text-gray-300">Refresh: 3-4 hours, Reset: 4-7 hours, Protect: 7-9 hours depending on vehicle condition.</p>
            </div>
